...
const Products = ({ initialProducts }) => {
    ...
    const { updateProducts, filteredProducts, handleCategoryChange, handleSortChange, handleSearchChange, totalProducts, addItemToCart, selectedProductIds, toggleSelectedProductId } = useContext(ProductContext);
            ...
            <section className="md:px-28 py-5">
                ...
                <div className="bg-gray-100 p-4 mb-8">
                    <div className="flex items-center gap-8">
                        <div className='flex items-center justify-between w-full mx-3 lg:hidden'>
                            <button type='button' className='flex gap-3 font-extrabold'>
                        ...
                        <div className='hidden lg:grid grid-cols-4 items-center px-3 w-full'>
                            <div>
                            ...
                            <div className="xl:flex items-center rounded-lg px-2">
                        ...
                        {filteredProducts.map((product) => (
                            <div key={product.id} className="rounded-lg bg-white text-center p-5 border relative shadow">
                                <Image
                                    ...
                                    height={27} width={27} alt='Wishlist' className='right-3 top-3 absolute cursor-pointer z-50'>
                                </Image>
